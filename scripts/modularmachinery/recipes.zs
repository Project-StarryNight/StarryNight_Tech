...
var fusionFuelUsage = 60;
var energyOutput = 600000;
var liquidEnergyOutput = 12;
var plasmaOutput = 2;
...
for i, weather in weathers {
    RecipeBuilder.newBuilder("Weather_generator_" + weather, "Weather_generator", 2400, 0,true)
        .setWeather(weather)
...
//发电
RecipeBuilder.newBuilder("ark_auxiliary_warehouse_day", "ark_auxiliary_warehouse", 2400, 0, true)
    .setTime(10, 12999)
    .addEnergyPerTickOutput(250000000)
    .build();

//发电
RecipeBuilder.newBuilder("ark_auxiliary_warehouse_night", "ark_auxiliary_warehouse", 2400, 0, true)
    .setTime(13000, 23992)
...
//β水晶-控制器
RecipeBuilder.newBuilder("controller_Energy_crystal_2", "acar", 51200)
...
//==============================粉碎机==============================
//粉碎-圆石
RecipeBuilder.newBuilder("item_shredder_cobblestone", "item_shredder", 60)
    .addEnergyPerTickInput(12800)
    .addItemInputs([
    ...
    .addItemOutput(<ic2:crafting:23> * 16).setChance(0.5)
    .addItemOutput(<ic2:crafting:23> * 16).setChance(0.25)
    .build();
...
RecipeBuilder.newBuilder("controller_star_collapser","acar", 7200)
    ...
    .addItemInputs([
        <enderio:item_capacitor_stellar> * 20,
        <enderio:block_alloy_endergy:3> * 20,
        <draconicevolution:draconic_block> * 20,
        <extrabotany:blockorichalcos> * 5,
